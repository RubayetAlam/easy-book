...
if(isset($_SESSION["flag"]) && $_SESSION["flag"]=="loginSuccess")
{
	...
	<body>
        ...
        <table>
            ...
            <tr>
                <td>
                   <center><img src="media/images1.png" alt="profile_img" height="240px" width="180px"></center> 
                </td>
                <td>
                    <tr>
                        <td></td>
                ...
                <td>
                        ...
                        <a href="hist.php" ><button>History</button></a>
                        <a href="Orderstatus.php" ><button>Order Status</button></a>
